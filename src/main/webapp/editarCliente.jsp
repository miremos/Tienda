...
<body>
				...
				<div class="contenedor">
					...
					<div class="input-group">
						<span class="input-group-text" id="basic-addon1">&#128179</span> <input
							...
							value="<%=result.getInt("cedula_cliente")%>" class="form-control"
					...
					<div class="input-group">
						<span class="input-group-text" id="basic-addon1">&#128204</span> <input
							...
							value="<%=result.getString("direccion_cliente")%>"
							class="form-control" aria-describedby="basic-addon1"
							pattern="[A-Za-z0-9#º/_()-Ññ´ ]{3,100}" required>
					</div>
					<label class="label">Correo</label>
					<div class="input-group">
						<span class="input-group-text" id="basic-addon1">&#9993</span> <input
							type="email" name="correo"
							value="<%=result.getString("email_cliente")%>"
					...
					<div class="input-group">
						<span class="input-group-text" id="basic-addon1">&#129333</span> <input
							...
							value="<%=result.getString("nombre_cliente")%>"
							class="form-control" aria-describedby="basic-addon1"
					...
					<div class="input-group">
						<span class="input-group-text" id="basic-addon1">&#128222</span> <input
							...
							value="<%=result.getString("telefono_cliente")%>"
							class="form-control" aria-describedby="basic-addon1" required>
					</div>
					<br>
					<div>
	...
	try {
	if (direccion != null && correo != null && nombre != null && telefono != null) {
		String sql = "UPDATE clientes set direccion_cliente = '" + direccion + "', email_cliente = '" + correo
		+ "', nombre_cliente = '" + nombre + "', telefono_cliente = '" + telefono + "' WHERE cedula_cliente ="
		+ cedula;
	...
	<div class="alert alert-success d-flex align-items-center" role="alert">
  	...
  	<path
		...
		<strong>Datos del Cliente Actualizados</strong>
