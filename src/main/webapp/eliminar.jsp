...
<script >
	...
	PreparedStatement ps = connexion.prepareStatement("DELETE FROM usuarios WHERE cedula_usuario ="+cedula);
	ps.executeUpdate();
...
<div class="alert alert-success d-flex align-items-center" role="alert">		
  ...
  <div>
    ...
    <strong>Datos del usuario Borrados</strong> 
 ...
 <!--<a type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close" href="usuarios.jsp">ACEPTAR</a>-->
