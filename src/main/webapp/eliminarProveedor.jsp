...
<body>
<jsp:include page="proveedores.jsp"></jsp:include>
	<%
	try{
	...
	PreparedStatement ps = connexion.prepareStatement("DELETE FROM proveedores WHERE nit_proveedor ="+nit);
	ps.executeUpdate();
  ...
  <svg xmlns="http://www.w3.org/2000/svg"  width="24" height="24" fill="currentColor" class="bi flex-shrink-0 me-2" viewBox="0 0 16 16" role="img" aria-label="Success:">
    ...
    <strong>Datos del proveedor Borrados</strong> 
