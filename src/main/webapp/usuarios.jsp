...
<body>
	...
	<nav class="navbar navbar-light bg-light">
		<script>
			...
			function confirmarAccesoURL() {
				return confirm("¿Está seguro que desea borrar el usuario?");
	...
	Connection connexion = java.sql.DriverManager.getConnection(
			...
			"root", "admin");
	PreparedStatement ps = connexion.prepareStatement("SELECT * FROM usuarios");
	ResultSet result = ps.executeQuery();
	%>
	<nav class="navbar navbar-light bg-light">
		<div class="container-fluid">
			<form class="d-flex" action="consultar.jsp" method="post">
				...
				<form action="agregarUsuario.jsp">
					<div class="dropdown">
						<button name="accion" value="Agregar"
							...
							<i class="fas fa-user-tie"></i> Agregar Usuario
						</button>
					</div>
				</form>
			</nav>
		...
		<div id="main-container">
			<table class="table table-striped">
				...
				<tr>
					...
					<td><a
						href="editar.jsp?cedula=<%=result.getInt("cedula_usuario")%>"><img
							src="img/editar.png" alt="30" width="30" /></a></td>
					<td><a
						href="eliminar.jsp?cedula=<%=result.getInt("cedula_usuario")%>"
