...
<body>
	...
	<form action="proveedores.jsp" method="post">
			...
			<div id="main-container">
				<table class="table table-striped">
					...
					<tr>
						...
						<td><a
							href="editar.jsp?nit=<%=result.getInt("nit_proveedor")%>"><img
								src="img/editar.png" alt="30" width="30" /></a></td>
						<td><a
							href="eliminar.jsp?nit=<%=result.getInt("nit_proveedor")%>"><img
  	...
  	<path
					...
					<strong>Proveedor Encontrado</strong>
    ...
    <path
					...
					<strong>Proveedor Inexistente</strong>
					<button type="button" class="btn-close" data-bs-dismiss="alert"
						aria-label="Close"></button>
				</div>
				<%
